...
namespace ControleDeAgendamento
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AgdDbContexto>(opcoes => opcoes.UseSqlServer(
            ...
            //Aqui é onde configuro a validação se o usuário esta logado
            services.AddIdentity<UserApplication, IdentityRole>().AddEntityFrameworkStores<AgdDbContexto>();
        }
